...
Sagara is an Integration and Identity Architect, a Product Manager with 15+ years of industry experience. Sagara spent 8 years at WSO2 in Architect & Product Manager roles for several WSO2 products. In 2019 he joined an Integration specialist - IntegrationWorks as the Principle Integration Consultant and moved to New Zealand. In 2022, Sagara joined back WSO2 and affiliated with WSO2 ANZ regional office in Sydney, Australia.  In present, Sagara serves as a Director - Solutions Architecture and focus on presales, customers, partner & community enablements in ANZ region. 

During his stay at IntegrationWorks he provided technical leadership in a collaborative approach of building a next-generation iPaaS offering based on cloud-native and open-source technologies. He also played a significant role in developing an in-house PaaS solution that combines cloud platforms, Integration & API-Management with modern DevOps practice. He also provided consultation for key clients especially developing Integration and Customer Identity strategies and roadmaps.

Previously, Sagara was the Architect & Product Manager for the WSO2 Identity Server and was responsible for defining & delivering the product roadmap and leading the product development team. WSO2 Identity Server has been named a Leader by KuppingerCole and as a Top Strong Performer by Forrester. Before that, Sagara played the Architect & Product Manager role for WSO2 Governance Registry and WSO2 Application Server products subsequently. Sagara played a significant role in designing and implementing Microservice development framework MSF4J. He has successfully led multiple on-site customer engagements for WSO2 in the USA, Europe, the UK, and APAC regions, including many Fortune 100/500 companies. 

Sagara also presented at several international conferences, including European Identity & Cloud Conference, Consumer Identity World EUROPE, Consumer Identity World APAC, GDPR Summit - London, ApacheCon NA, WSO2 Summit Sydney, WSO2Con USA, EU & Asia events. He has written numerous articles and technical papers related to Integration, Identity, RESTful design, and Microservices for the WSO2, Industry Index, PCMag, and DZone.
